...
let renderPokemons = (pokemon) => {
    ...
    <div class="card-title text-center pokemonValue2 fw-bold pb-2 text-warning pokName" style="display:none; font-size:22px">${i.name}</div>
    ...
    <button class="card-title  text-center pokemonValue2 fw-bold pb-2 pokName text-white text-bg-info" style="display:none; font-size:22px">Choose</button>
    <div class="card-body">
